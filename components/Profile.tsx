...
//       <div className="mt-8">
//         <h1 className="text-2xl font-bold">Guide by {name}</h1>
//         <p className="text-gray-500 mt-1">Joined in {joinDate}</p>
        
//         <div className="flex gap-3 mt-4">
//           <a href={socialLinks.website} className="text-gray-700 hover:text-gray-900">
//             <Globe size={22} />
//           </a>
//           <a href={socialLinks.instagram} className="text-gray-700 hover:text-gray-900">
//             <Instagram size={22} />
//           </a>
//           <a href={socialLinks.tiktok} className="text-gray-700 hover:text-gray-900">
...
//             </svg>
//           </a>
//           <a href={socialLinks.threads} className="text-gray-700 hover:text-gray-900">
//             <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
